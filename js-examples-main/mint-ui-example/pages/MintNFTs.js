...
export const MintNFTs = ({ onClusterChange }) => {
  ...
  console.log("candyMachineAddress", candyMachineAddress.toBase58());
  let candyMachine;
  let walletBalance;
  ...
  const onClick = async () => {
    ...
    //     candyGuard: candyMachine.candyGuard.baseAddress,
    //   group: "WL",
    //   // guards: {
    ...
    const { nft } = await metaplex.candyMachines().mint({
      ...
      // collectionUpdateAuthority: candyMachine.authorityAddress,
        // candyGuard: candyMachine.candyGuard.baseAddress,
        // candyMachine: candyMachine.address,
        candyGuard: candyMachine.candyGuard?.baseAddress, // It was not set up correctly.
        // nftMint: nftSigner,
